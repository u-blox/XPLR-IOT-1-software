...
#ifndef X_SENS_LTR303_H__
#define  X_SENS_LTR303_H__


/** @file
 * @brief This header file defines the API for LTR303 sensor
 ...
 * Command Example: sensors LTR303 publish on
 *
 ...
 * Command Example: sensors LTR303 set_period 10000
 *
 * @param shell  the shell instance from which the command is given.
 * @param argc   the number of parameters given along with the command.
 * @param argv   the array including the parameters themselves.
