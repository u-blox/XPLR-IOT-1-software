...
#ifndef X_SENS_LIS2DH12_H__
#define  X_SENS_LIS2DH12_H__


/** @file
 * @brief This header file defines the API for LIS2DH12 sensor
 ...
 * Command Example: sensors LIS2DH12 publish on
 *
 ...
 * Command Example: sensors LIS2DH12 set_period 10000
 *
 * @param shell  the shell instance from which the command is given.
 * @param argc   the number of parameters given along with the command.
 * @param argv   the array including the parameters themselves.
