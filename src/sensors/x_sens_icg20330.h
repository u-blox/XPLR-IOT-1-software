...
#ifndef X_SENS_ICG20330_H__
#define  X_SENS_ICG20330_H__


/** @file
 * @brief This header file defines the API for ICG20330 sensor
 ...
 * Command Example: sensors ICG20330 publish on
 *
 ...
 * Command Example: sensors ICG20330 set_period 10000
 *
 * @param shell  the shell instance from which the command is given.
 * @param argc   the number of parameters given along with the command.
 * @param argv   the array including the parameters themselves.
