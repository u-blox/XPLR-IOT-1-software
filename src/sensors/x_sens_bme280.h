...
#ifndef X_SENS_BME280_H__
#define  X_SENS_BME280_H__


/** @file
 * @brief This header file defines the API for BME280 sensor
 ...
 * Command Example: sensors BME280 publish on
 *
 ...
 * Command Example: sensors BME280 set_period 10000
 *
 * @param shell  the shell instance from which the command is given.
 * @param argc   the number of parameters given along with the command.
 * @param argv   the array including the parameters themselves.
